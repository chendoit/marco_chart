...
_module = ChartModule(
    ...
    charts=[
        {
            "title": "S&P500 與Fed Rates",
            "ids": [356, 5549, (1150443, '-', 1150440), 1645],
            "axis": [0, 0, 1, 3, 3],
            "summary":
        ...
        {
            "title": "FED 利率預測",
            "ids": [356, 5549, (1150443, '-', 1150440)],
            "axis": [0, 0, 2, 3, 3],
            "summary": "這個也應對到美元流動性不足 SOFR75",
            "plot_lines": [((1150443, '-', 1150440), -0.25)],
        },
        {
            "title": "FED 利率預測",
            "ids": [356, 5549, 354, (1150443, '-', 1150440), 483],
            "axis": [0, 0, 0, 3, 4],
            "summary": "2024 九月預計降4次 到2025/1月預期不降息, 但是9月之後美元指數和10年殖利率因為流動性不足一直上揚",
        },
    ],
)
