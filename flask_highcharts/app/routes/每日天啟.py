...
_module = ChartModule(
    ...
    有時VVIX領跑, 如果日圓空頭高位有機會伴隨日圓升值(避險貨幣真義)! """,
        ...
        },
        {
            ...
            "ids": [({"ZSUM": _VIX_LONG_FLOW}, '-', {"ZSUM": _VIX_SHORT_FLOW}), 2, 355],
            "axis": [0, 1, 2],
            "summary":
        ...
        {
            "title": "CBOE VIX Futures Index (LONGVOL vs SHORTVOL) vs SPX",
            "ids": [2, "cboe_LONGVOL", "cboe_SHORTVOL"],
            "axis": [0, 1, 2],
            "summary":
        ...
        {
            "title": "SPX vs VIX vs NFCI vs SHORTVOL",
            "ids": [2, 355, 5696, "cboe_SHORTVOL"],
            "axis": [0, 1, 2, 3],
            "summary":
