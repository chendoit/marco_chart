...
_module = ChartModule(
    ...
    chart_titles=[
        "美德利差與DXY",
        "日圓/美元, DXY與SOFR IORB spread, 美日利差",
        "日圓/美元與SOFR IORB spread, 美日利差",
        "日圓/美元與SOFR IORB spread",
        "美日利差與Fedwatch升降息機率",
    ],
    chart_ids=[
        [4448, 562, 483],
        [4456, 385, 483, (6225, '-', 19268)],
        [4456, 385, (6225, '-', 19268)],
        [(6222, '-', 19268), 385, (6225, '-', 19268)],
        [356, 354, 1645, 484, 4456, 385],
    ],
    axis_config=[
        None,
        None,
